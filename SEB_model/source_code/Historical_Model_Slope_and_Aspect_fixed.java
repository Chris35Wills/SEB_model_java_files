 ...
 * @author Chris
 */
public class Historical_Model_Slope_and_Aspect_fixed implements ActionListener {

    private GUIPanel panel = null;
    private Storage store = null;

    Historical_Model_Slope_and_Aspect_fixed(GUIPanel panel, Storage store) {
...
//        ListIterator iterator8b = store.get_Winter_MonthFile().listIterator();
        ...
        //File f_stats = new File("F:/Melt_modelling/Historical_model_outputs_aspect_and_slope_fixed/Historical_model_run_mean_stats.txt");
        File f_stats = new File("C:/Users/Chris/Desktop/19261943/Historical_model_outputs_aspect_and_slope_fixed/Historical_model_run_mean_stats.txt");
...
//                            System.out.println("End test loop (2)");
                ...
                if (save_arrays == 1) {
                     ...
                     *
                     */
                    File f_summer_precip = new File("F:/Melt_modelling/Historical_model_outputs_aspect_and_slope_fixed/summer_precip_" + month + "_" + year + ".txt");
                ...
                if (save_arrays == 1) {
                     ...
                     *
                     */
                    File f_winter_precip = new File("F:/Melt_modelling/Historical_model_outputs_aspect_and_slope_fixed/winter_precip_" + month + "_" + year + ".txt");
                ...
                if (save_arrays == 1) {
                     ...
                     *
                     */
                    File f_monthly_psi = new File("F:/Melt_modelling/Historical_model_outputs_aspect_and_slope_fixed/monthly_psi_" + month + "_" + year + ".txt");
...
//           double loop_hillshade = 1.0; // Use to set clearsky conditions (i.e. no topog. shading)
                ...
                if (daily_surfaceRadiationSurface != null) {
                    ...
                    if (save_arrays == 1) {
                         ...
                         *
                         */
                        File f_monthly_rad = new File("F:/Melt_modelling/Historical_model_outputs_aspect_and_slope_fixed/mean_monthly_rad_" + month + "_" + year + ".txt");
...
//    double Q_counter = 0;
                    ...
                    if ((save_arrays == 1)|(save_arrays == 4)) {
                        ...
                        //File f_Q_monthly = new File("F:/Melt_modelling/Historical_model_outputs_aspect_and_slope_fixed/Q_monthly_" + (int) month + "." + (int) year + ".txt");
                        File f_Q_monthly = new File("C:/Users/Chris/Desktop/19261943/Historical_model_outputs_aspect_and_slope_fixed/Q_monthly_" + (int) month + "." + (int) year + ".txt");
...
//                        glacier_thickness[i][j] = glacier_thickness[i][j] - ice_thickness_change_surface[i][j];
                     ...
                     */
                    if (save_arrays == 1) {
                        File f_glacier_thickness = new File("F:/Melt_modelling/Historical_model_outputs_aspect_and_slope_fixed/updated_thickness_" + (int) month + "." + (int) year + ".txt");
                     ...
                     */
                    if (save_arrays == 1) {
                        File f_elevation_update = new File("F:/Melt_modelling/Historical_model_outputs_aspect_and_slope_fixed/updated_elevation_" + (int) month + "." + (int) year + ".txt");
                 ...
                 */
                if (save_arrays == 3) {
                    File f_Slope_Surface = new File("F:/Melt_modelling/Historical_model_outputs_aspect_and_slope_fixed/slope_" + (int) month + "." + (int) year + ".txt");
                 ...
                 */
                if (save_arrays == 3) {
                    File f_aspectSurface = new File("F:/Melt_modelling/Historical_model_outputs_aspect_and_slope_fixed/aspect_" + (int) month + "." + (int) year + ".txt");
