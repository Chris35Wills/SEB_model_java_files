 ...
 * 
 * This code differs to the normal "Historical_Model_Precip_winter_snow_limit.java"
 ...
 * @author Chris
 */
public class Historical_model_dynamic_LARGE_FILES implements ActionListener {

    private GUIPanel panel = null;
    private Storage store = null;

    Historical_model_dynamic_LARGE_FILES(GUIPanel panel, Storage store) {
...
////        File f_stats = new File("F:/Melt_modelling/Historical_model_outputs_snow_thickness_m05/Historical_model_run_mean_stats.txt");
    File f_stats = new File("C:/Users/Chris/Desktop/19262010/Historical_model_outputs/Historical_model_run_mean_stats.txt");
...
//                        File f_Q_monthly = new File("F:/Melt_modelling/Historical_model_outputs/Q_monthly_" + (int) month + "." + (int) year + ".txt");
                        File f_Q_monthly = new File("C:/Users/Chris/Desktop/19262010/Historical_model_outputs/Q_monthly_" + (int) month + "." + (int) year + ".txt");
