 ...
 * @author Chris
 */
public class OpenHillShade_Feb_midnight_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_Feb_midnight_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("February midnight working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open February midnight hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("February midnight hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_Feb_midnight[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Feb_midnight(hillshade_Feb_midnight);
    ...
    System.out.println("February midnight hillshade uploaded");
