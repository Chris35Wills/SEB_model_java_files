 ...
 * @author Chris
 */
public class OpenHillShade_Feb_noon_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_Feb_noon_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("February noon working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open February noon hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("February noon hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_Feb_noon[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Feb_noon(hillshade_Feb_noon);
    ...
    System.out.println("February noon hillshade uploaded");
