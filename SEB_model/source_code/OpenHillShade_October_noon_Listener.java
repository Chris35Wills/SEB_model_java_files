 ...
 * @author Chris
 */
public class OpenHillShade_October_noon_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_October_noon_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("October noon working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open October noon hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("October noon hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_October_noon[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Oct_noon(hillshade_October_noon);
    ...
    System.out.println("October noon hillshade uploaded");
