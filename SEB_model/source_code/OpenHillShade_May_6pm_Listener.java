 ...
 * @author Chris
 */
public class OpenHillShade_May_6pm_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_May_6pm_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("May 6pm working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open May 6pm hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("May 6pm hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_May_6pm[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_May_6pm(hillshade_May_6pm);
    ...
    System.out.println("May 6pm hillshade uploaded");
