 ...
 * @author Chris
 */
public class OpenHillShade_March_noon_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_March_noon_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("March noon working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open March noon hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("March noon hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_March_noon[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_March_noon(hillshade_March_noon);
    ...
    System.out.println("March noon hillshade uploaded");
