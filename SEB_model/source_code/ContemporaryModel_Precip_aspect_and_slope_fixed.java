 ...
 * precipitation algorithms. THIS FIXES THE ASPECT and SLOPE CALCULATION. To 
 * facilitate fixed aspect and slope surfaces, aspect is calculated outside of 
 * the loop once, is then set and then not recalculated again.
 *  
 ...
 * @author Chris
 */
public class ContemporaryModel_Precip_aspect_and_slope_fixed implements ActionListener {

    private GUIPanel panel = null;
    private Storage store = null;

    ContemporaryModel_Precip_aspect_and_slope_fixed(GUIPanel panel, Storage store) {
...
//        System.out.println("Winter days 10-11:" + winter_days_1011_counter);
        ...
        File f_stats = new File("F:/Melt_modelling/Model_outputs_slope_and_aspect_fixed/Model_run_mean_stats.txt");
...
//                        glacier_thickness[i][j] = glacier_thickness[i][j] - ice_thickness_change_surface[i][j];
                ...
                if (save_arrays == 1) {
                    ...
                    File f2 = new File("F:/Melt_modelling/Model_outputs_slope_and_aspect_fixed/surfaceRadiationSurface_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                    ...
                    File f_psi_surface = new File("F:/Melt_modelling/Model_outputs_slope_and_aspect_fixed/psi_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
...
//
                ...
                if ((save_arrays == 1)|(save_arrays == 4)) {
                    File f_q_daily = new File("F:/Melt_modelling/Model_outputs_slope_and_aspect_fixed/Q_daily_grid_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
...
//
                 ...
                 */
                if (save_arrays == 1) {
                    File f_glacier_thickness = new File("F:/Melt_modelling/Model_outputs_slope_and_aspect_fixed/updated_thickness_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
                 ...
                 */
                if (save_arrays == 1) {
                    File f_elevation_update = new File("F:/Melt_modelling/Model_outputs_slope_and_aspect_fixed/updated_elevation_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
                 ...
                 */
                if (save_arrays == 3) {
                    File f_glacier_slope = new File("F:/Melt_modelling/Model_outputs_slope_and_aspect_fixed/slope_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
                 ...
                 */
                if (save_arrays == 3) {
                    File f_aspectSurface = new File("F:/Melt_modelling/Model_outputs_slope_and_aspect_fixed/aspect_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
...
//              12. Loop back to the top and continue until end of all lists - DONE
         ...
         */
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        File f_summer_snow = new File("F:/Melt_modelling/Model_outputs_slope_and_aspect_fixed/summer_snow.txt");
...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            File f_winter_snow = new File("F:/Melt_modelling/Model_outputs_slope_and_aspect_fixed/winter_snow.txt");
//  
