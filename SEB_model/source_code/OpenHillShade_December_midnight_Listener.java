 ...
 * @author Chris
 */
public class OpenHillShade_December_midnight_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_December_midnight_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("December midnight working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open December midnight hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("December midnight hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_December_midnight[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Dec_midnight(hillshade_December_midnight);
    ...
    System.out.println("December midnight hillshade uploaded");
