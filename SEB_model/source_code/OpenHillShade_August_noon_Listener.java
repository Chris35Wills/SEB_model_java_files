 ...
 * @author Chris
 */
public class OpenHillShade_August_noon_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_August_noon_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("August noon working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open August noon hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("August noon hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_August_noon[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_August_noon(hillshade_August_noon);
    ...
    System.out.println("August noon hillshade uploaded");
