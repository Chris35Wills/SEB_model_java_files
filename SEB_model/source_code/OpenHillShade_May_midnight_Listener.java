 ...
 * @author Chris
 */
public class OpenHillShade_May_midnight_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_May_midnight_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("May midnight working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open May midnight hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("May midnight hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_May_midnight[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_May_midnight(hillshade_May_midnight);
    ...
    System.out.println("May midnight hillshade uploaded");
