 ...
 * ****************************************************************************
 * 
 * Contemporary model - normal data upload
 ...
 * lapse rate surfaces (for bulk flux and sumemr precipitation calculations) and
 * elevation surfaces for the winter precipitation thickness claculation 
 * (historical model only) are based on the initial DEM elevation values. The 
 * surface from which these are called is set outside of the main model loop. 
 * The changing elevation for thickness, slope and aspect change is calculated 
 * within the loop and therefore is allowed, itself, to change.
 * 
 * @Chris 20/8/13
 */
 ...
 * @author Chris
 */
public class ContemporaryModel_Precip_elev_fixed implements ActionListener {

    private GUIPanel panel = null;
    private Storage store = null;

    ContemporaryModel_Precip_elev_fixed(GUIPanel panel, Storage store) {
...
//        System.out.println("Winter days 10-11:" + winter_days_1011_counter);
        ...
        File f_stats = new File("F:/Melt_modelling/Model_outputs_ELEV_FIXED/Model_run_mean_stats.txt");
        
//        File f_stats = new File("F:/Melt_modelling/Model_outputs_snow_thickness_m1/Model_run_mean_stats.txt");
        ...
        try {
            ...
            while (iterator0.hasNext()) {
                ...
                //System.out.println("Snow thickness being tested: minus 1.0");
                ...
                for (int i = 0; i < elevation.length; i++) {
                    for (int j = 0; j < elevation[i].length; j++) {
                        ...
                        if (elevation[i][j] != NODATA_value) {
                            ...
                            slope_dzdx = (((slopeC + (2 * slopeF) + slopeI) - (slopeA + (2 * slopeD) + slopeG)) / (8 * 5)); //Don't hardwire the cell size (5) - make it dynamic
                            slope_dzdy = (((slopeG + (2 * slopeH) + slopeI) - (slopeA + (2 * slopeB) + slopeC)) / (8 * 5)); //Don't hardwire the cell size (5) - make it dynamic
...
//                        glacier_thickness[i][j] = glacier_thickness[i][j] - ice_thickness_change_surface[i][j];
                ...
                if (save_arrays == 1) {
                    ...
                    File f2 = new File("F:/Melt_modelling/Model_outputs_ELEV_FIXED/surfaceRadiationSurface_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
                    ...
                    File f_psi_surface = new File("F:/Melt_modelling/Model_outputs_ELEV_FIXED/psi_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
...
//
                ...
                if ((save_arrays == 1)|(save_arrays == 4)) {
                    File f_q_daily = new File("F:/Melt_modelling/Model_outputs_ELEV_FIXED/Q_daily_grid_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
                                      
                    // File f_q_daily = new File("F:/Melt_modelling/Model_outputs_snow_thickness_m1/Q_daily_grid_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
...
//
                 ...
                 */
                if (save_arrays == 1) {
                    File f_glacier_thickness = new File("F:/Melt_modelling/Model_outputs_ELEV_FIXED/updated_thickness_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
                 ...
                 */
                if (save_arrays == 1) {
                    File f_elevation_update = new File("F:/Melt_modelling/Model_outputs_ELEV_FIXED/updated_elevation_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
                 ...
                 */
                if (save_arrays == 3) {
                    File f_glacier_slope = new File("F:/Melt_modelling/Model_outputs_ELEV_FIXED/slope_" + (int) day + "." + (int) month + "." + (int) year + ".txt");

                    DecimalFormat df_glacier_slope = new DecimalFormat("#.####");

                    try {
                        BufferedWriter bw_glacier_slope = new BufferedWriter(new FileWriter(f_glacier_slope));
                        bw_glacier_slope.write("ncols" + "         " + store.getOriginalNcols());
                        bw_glacier_slope.write(System.getProperty("line.separator"));
                        bw_glacier_slope.write("nrows" + "         " + store.getOriginalNrows());
                        bw_glacier_slope.write(System.getProperty("line.separator"));
                        bw_glacier_slope.write("xllcorner" + "     " + store.getOriginalXllcorner());
                        bw_glacier_slope.write(System.getProperty("line.separator"));
                        bw_glacier_slope.write("yllcorner" + "     " + store.getOriginalYllcorner());
                        bw_glacier_slope.write(System.getProperty("line.separator"));
                        bw_glacier_slope.write("cellsize" + "      " + store.getOriginalCellsize());
                        bw_glacier_slope.write(System.getProperty("line.separator"));
                        bw_glacier_slope.write("NODATA_value" + "  " + "-9999");
                        bw_glacier_slope.write(System.getProperty("line.separator"));
                        ...
                        for (int a = 0; a < Slope_Surface.length; a++) {
                            for (int b = 0; b < Slope_Surface[a].length; b++) {
                                ...
                                if (Slope_Surface[a][b] == NODATA_value) {
                                    ...
                                    bw_glacier_slope.write("-9999 ");
                                } else {

                                    bw_glacier_slope.write(df_glacier_slope.format(Slope_Surface[a][b]) + " ");

                                }

                            }
                            bw_glacier_slope.newLine();
                        }

                        bw_glacier_slope.close();
                    ...
                    System.out.println("Slope check: " + f_glacier_slope.getAbsolutePath());
                 ...
                 */
                if (save_arrays == 3) {
                    File f_aspectSurface = new File("F:/Melt_modelling/Model_outputs_ELEV_FIXED/aspect_" + (int) day + "." + (int) month + "." + (int) year + ".txt");
...
//              12. Loop back to the top and continue until end of all lists - DONE
         ...
         */
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        File f_summer_snow = new File("F:/Melt_modelling/Model_outputs_ELEV_FIXED/summer_snow.txt");
...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            File f_winter_snow = new File("F:/Melt_modelling/Model_outputs_ELEV_FIXED/winter_snow.txt");
//  
...
//
            ...
            System.out.println("Ordinarily, the winter snow surface would be printed out - the input data must be summer season only");
        }
    }
    ...
    public double LapseRate(double elevation, double BaseTemp) {
        ...
        double equalizedElevation = elevation - BaseElevation; // Calculates height difference between met station and point of interest
        
        //double pseudoTemp = equalizedElevation * 0.0070; // SENSITIVITY TEST
