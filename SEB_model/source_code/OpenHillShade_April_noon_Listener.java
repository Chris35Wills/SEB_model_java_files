 ...
 * @author Chris
 */
public class OpenHillShade_April_noon_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_April_noon_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("April noon working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open April noon hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("April noon hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_April_noon[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_April_noon(hillshade_April_noon);
    ...
    System.out.println("April noon hillshade uploaded");
