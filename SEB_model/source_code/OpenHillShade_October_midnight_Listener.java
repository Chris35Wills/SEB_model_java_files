 ...
 * @author Chris
 */
public class OpenHillShade_October_midnight_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_October_midnight_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("October midnight working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open October midnight hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("October midnight hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_October_midnight[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Oct_midnight(hillshade_October_midnight);
    ...
    System.out.println("October midnight hillshade uploaded");
