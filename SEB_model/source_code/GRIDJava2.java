 ...
 **/
public class GRIDJava2
{

  Storage store = null;
  private double[][] twoDdoubleArray = null;
  private String[][] twoDStringArray = null;
  private int ncols, nrows, NODATA_value = 0, cellsize = 0;
  private double xllcorner, yllcorner;
  private boolean debug = false;

  public GRIDJava2(File file, boolean convertToInts, Storage s)
  {
    ...
    //System.out.println("path 2a = " + file.getAbsolutePath());
    //System.out.println("path 2b = " + file.getCanonicalPath());
    try
    {
      ...
      try
      {
        ...
        store.setOriginalXllcorner(xllcorner);
        if (debug == true)
        {
      ...
      try
      {
        ...
        store.setOriginalYllcorner(yllcorner);
        if (debug == true)
        {
      ...
      try
      {
        ...
        cellsize = Integer.parseInt(getNextParameter(buff));
        store.setOriginalCellsize((int) cellsize);
        if (debug == true)
        {
