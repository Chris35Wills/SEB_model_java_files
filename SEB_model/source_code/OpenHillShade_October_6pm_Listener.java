 ...
 * @author Chris
 */
public class OpenHillShade_October_6pm_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_October_6pm_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("October 6pm working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open October 6pm hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("October 6pm hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_October_6pm[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Oct_6pm(hillshade_October_6pm);
    ...
    System.out.println("October 6pm hillshade uploaded");
