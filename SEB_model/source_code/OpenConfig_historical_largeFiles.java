 ...
 * of use of buttons.
 * 
 * DIFFERS TO THE OTHER CONFIG UPLOADS AS INSTANCES OF COMPLETE DARKNESS (WHEN 
 * HILLSHADE IS SET TO 0) ARE ONLY UPLOADED AND CALLED ONCE. THEY ARE SET AND 
 * CALLED USING THE get or setHillshade_Jan_Midnight() methods
 * 
 * @author Chris 17/4/13
 */

public class OpenConfig_historical_largeFiles implements ActionListener {
   
  private GUIPanel panel = null;
  private Storage store = null;
  
  OpenConfig_historical_largeFiles (GUIPanel panel, Storage store)
  {
  ...
  {
      int Memory_usage = 1; // set to 0: no memory usage printout
                               // set to 1: memory usage printout (total available and total used)
      Runtime runtime = Runtime.getRuntime();
      long memory;
      
      //ResourceBundle MeltModelConfig = ResourceBundle.getBundle("Model_props_winter_19261943_historic_LARGE_FILES");
      ResourceBundle MeltModelConfig = ResourceBundle.getBundle("Model_props_winter_19262010_historic_LARGE_FILES");
      ...
      String key_hsm1 = MeltModelConfig.getString("JanHS_midnight");// This is the 0 hillshade surface
...
//                        System.out.println("Azimuth 6pm: " + Azimuth_6pm_store);
    ...
    System.out.println("Radiation data uploaded");
      ...
      //*********************************************** HILLSHADE *************
                         ...
                         // SETS A ZERO HILLSHADE SURFACE I.E. DARKNESS 
                         // (uses the January midnight hillshade method)
...
//      
//      File f_feb_HS = new File(key_hsm1);
...
//      //March HS midnight
//            
//      File f_mar_HS = new File(key_hsm1);
...
//      //April HS midnight
//            
//      File f_april_HS = new File(key_hsm1);
...
//      //May HS midnight
//            
//      File f_may_HS = new File(key_hsm1);
...
//      //August HS midnight
//            
//      File f_aug_HS = new File(key_hsm1);
...
//            
//      File f_sept_HS = new File(key_hsm1);
...
//      //October HS midnight
//            
//      File f_oct_HS = new File(key_hsm1);
...
//            
//      File f_nov_HS = new File(key_hsm1);
...
//            
//      File f_dec_HS = new File(key_hsm1);
...
//      //January HS_6am 
//      
//      File f_jan_HS_6am = new File(key_hsm1);
...
//      //February HS_6am 6am
//      
//      File f_feb_HS_6am = new File(key_hsm1);
...
//      //March HS_6am 6am
//            
//      File f_mar_HS_6am = new File(key_hsm1);
...
//      }
      ...
      File f_sept_HS_6am = new File(key_hsm1);
...
//      //October HS_6am 6am
//            
//      File f_oct_HS_6am = new File(key_hsm1);
...
//      //November HS_6am 6am
//            
//      File f_nov_HS_6am = new File(key_hsm1);
...
//      //December HS_6am 6am
//            
//      File f_dec_HS_6am = new File(key_hsm1);
...
//      //December HS_noon 
//            
//      File f_dec_HS_noon = new File(key_hsm1);
...
//      //January HS_6pm 
//      
//      File f_jan_HS_6pm = new File(key_hsm1);
...
//      //February HS_6pm
//      
//      File f_feb_HS_6pm = new File(key_hsm1);
//      GRIDJava2 gj4d = new GRIDJava2(f_feb_HS_6pm, true, store);
...
//      //March HS_6pm
//            
//      File f_mar_HS_6pm = new File(key_hsm1);
...
//      //October HS_6pm 
//            
//      File f_odt_HS_6pm = new File(key_hsm1);
...
//      //November HS_6pm 
//            
//      File f_nov_HS_6pm = new File(key_hsm1);
...
//      //December HS_6pm 
//            
//      File f_dec_HS_6pm = new File(key_hsm1);
