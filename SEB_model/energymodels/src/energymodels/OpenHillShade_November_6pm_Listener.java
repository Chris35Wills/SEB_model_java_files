 ...
 * @author Chris
 */
public class OpenHillShade_November_6pm_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_November_6pm_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
   ...
   // Creates the "Open a File" dialog box
    ...
    FileDialog fd = new FileDialog(new Frame (), "Open November 6pm hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
