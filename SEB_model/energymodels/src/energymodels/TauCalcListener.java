...
public class TauCalcListener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;
  
  TauCalcListener (GUIPanel panel, Storage store)
  {
...
//            }
    ...
    //File f2 = new File("F:/Melt_modelling/Model_outputs/Tau_calculator_output_to_check.txt");
    FileDialog fd2 = new FileDialog(new Frame(), 
                                        "Save Tau estimation file", FileDialog.SAVE);
    fd2.setVisible(true);
//
    File f2 = new File(fd2.getDirectory() + fd.getFile());
    FileWriter fw = null;
