 ...
 * 
 * This code differs to the aspect and slope fixed version of
 ...
 * @author Chris
 */
public class Historical_Model_Slope_and_Aspect_fixed_LARGE_FILES implements ActionListener {

    private GUIPanel panel = null;
    private Storage store = null;

    Historical_Model_Slope_and_Aspect_fixed_LARGE_FILES(GUIPanel panel, Storage store) {
...
//        ListIterator iterator8b = store.get_Winter_MonthFile().listIterator();
        ...
        File f_stats = new File("C:/Users/Chris/Desktop/19262010/Historical_model_outputs_aspect_and_slope_fixed/Historical_model_run_mean_stats.txt");
...
//    double Q_counter = 0;
                    ...
                    if ((save_arrays == 1)|(save_arrays == 4)) {
                        ...
                        File f_Q_monthly = new File("C:/Users/Chris/Desktop/19262010/Historical_model_outputs_aspect_and_slope_fixed/Q_monthly_" + (int) month + "." + (int) year + ".txt");
