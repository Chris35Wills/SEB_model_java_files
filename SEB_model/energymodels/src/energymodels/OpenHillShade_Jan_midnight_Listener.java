 ...
 * @author Chris
 */
public class OpenHillShade_Jan_midnight_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_Jan_midnight_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("January midnight working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open January midnight hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("January midnight hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_Jan_midnight[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Jan_midnight(hillshade_Jan_midnight);
    ...
    System.out.println("January midnight hillshade uploaded");
