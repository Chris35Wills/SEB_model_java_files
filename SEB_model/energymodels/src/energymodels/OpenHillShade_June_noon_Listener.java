 ...
 * @author Chris
 */
public class OpenHillShade_June_noon_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_June_noon_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("June noon working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open June noon hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("June noon hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_June_noon[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_June_noon(hillshade_June_noon);
    ...
    System.out.println("June noon hillshade uploaded");
