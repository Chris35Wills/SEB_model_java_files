 ...
 * @author Chris
 */
public class OpenHillShade_June_midnight_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_June_midnight_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("June midnight working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open June midnight hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("June midnight hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_June_midnight[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_June_midnight(hillshade_June_midnight);
    ...
    System.out.println("June midnight hillshade uploaded");
