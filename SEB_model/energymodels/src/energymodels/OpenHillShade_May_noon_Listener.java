 ...
 * @author Chris
 */
public class OpenHillShade_May_noon_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_May_noon_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("May noon working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open May noon hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("May noon hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_May_noon[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_May_noon(hillshade_May_noon);
    ...
    System.out.println("May noon hillshade uploaded");
