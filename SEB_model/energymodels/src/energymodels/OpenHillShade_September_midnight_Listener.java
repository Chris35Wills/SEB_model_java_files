 ...
 * @author Chris
 */
public class OpenHillShade_September_midnight_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_September_midnight_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("September midnight working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open September midnight hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("September midnight hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_September_midnight[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Sept_midnight(hillshade_September_midnight);
    ...
    System.out.println("September midnight hillshade uploaded");
