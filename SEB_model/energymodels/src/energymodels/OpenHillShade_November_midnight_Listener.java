 ...
 * @author Chris
 */
public class OpenHillShade_November_midnight_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_November_midnight_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("November midnight working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open November midnight hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("November midnight hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_November_midnight[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Nov_midnight(hillshade_November_midnight);
    ...
    System.out.println("November midnight hillshade uploaded");
