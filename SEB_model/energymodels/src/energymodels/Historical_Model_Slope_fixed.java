 ...
 * @author Chris
 */
public class Historical_Model_Slope_fixed implements ActionListener {

    private GUIPanel panel = null;
    private Storage store = null;

    Historical_Model_Slope_fixed(GUIPanel panel, Storage store) {
...
//        ListIterator iterator8b = store.get_Winter_MonthFile().listIterator();
        ...
        File f_stats = new File("C:/Users/Chris/Desktop/19261943/Historical_model_outputs_slope_fixed/Historical_model_run_mean_stats.txt");
        FileWriter fw_stats;
...
//   System.out.println("Month: " + month);
            ...
            // Loop through slope array and match position on aspect array
...
//    double Q_counter = 0;
                    ...
                    if ((save_arrays == 1)|(save_arrays == 4)) {
                        ...
                        File f_Q_monthly = new File("C:/Users/Chris/Desktop/19261943/Historical_model_outputs_slope_fixed/Q_monthly_" + (int) month + "." + (int) year + ".txt");
