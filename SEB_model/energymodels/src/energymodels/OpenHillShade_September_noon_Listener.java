 ...
 * @author Chris
 */
public class OpenHillShade_September_noon_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_September_noon_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("September noon working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open September noon hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("September noon hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_September_noon[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Sept_noon(hillshade_September_noon);
    ...
    System.out.println("September noon hillshade uploaded");
