 ...
 * @author Chris
 */
public class OpenHillShade_April_midnight_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_April_midnight_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("April midnight working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open April midnight hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("April midnight hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_April_midnight[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_April_midnight(hillshade_April_midnight);
    ...
    System.out.println("April midnight hillshade uploaded");
