 ...
 * @author Chris
 */
public class OpenHillShade_March_midnight_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_March_midnight_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("March midnight working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open March midnight hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("March midnight hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_March_midnight[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_March_midnight(hillshade_March_midnight);
    ...
    System.out.println("March midnight hillshade uploaded");
