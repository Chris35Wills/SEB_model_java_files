 ...
 * @author Chris
 */
public class OpenHillShade_November_noon_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_November_noon_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("November noon working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open November noon hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("November noon hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_November_noon[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Nov_noon(hillshade_November_noon);
    ...
    System.out.println("November noon hillshade uploaded");
