 ...
 * @author Chris
 */
public class OpenHillShade_July_midnight_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_July_midnight_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("July midnight working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open July midnight hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("July midnight hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_July_midnight[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_July_midnight(hillshade_July_midnight);
    ...
    System.out.println("July midnight hillshade uploaded");
