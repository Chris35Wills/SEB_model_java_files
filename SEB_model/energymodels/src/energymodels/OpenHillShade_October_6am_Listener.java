 ...
 * @author Chris
 */
public class OpenHillShade_October_6am_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_October_6am_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("October 6am working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open October 6am hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("October 6am hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_October_6am[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Oct_6am(hillshade_October_6am);
    ...
    System.out.println("October 6am hillshade uploaded");
