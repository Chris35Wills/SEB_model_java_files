 ...
 * @author Chris
 */
public class OpenHillShade_Jan_noon_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_Jan_noon_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("January noon working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open January noon hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("January noon hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_Jan_noon[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Jan_noon(hillshade_Jan_noon);
    ...
    System.out.println("January noon hillshade uploaded");
