 ...
 * @author Chris
 */
public class OpenHillShade_December_noon_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_December_noon_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("December noon working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open December noon hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("December noon hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_December_noon[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_Dec_noon(hillshade_December_noon);
    ...
    System.out.println("December noon hillshade uploaded");
