 ...
 * @author Chris
 */
public class OpenHillShade_June_6pm_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_June_6pm_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("June 6pm working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open June 6pm hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("June 6pm hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_June_6pm[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_June_6pm(hillshade_June_6pm);
    ...
    System.out.println("June 6pm hillshade uploaded");
