 ...
 * @author Chris
 */
public class OpenHillShade_March_6am_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_March_6am_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("March 6am working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open March 6am hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("March 6am hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_March_6am[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_March_6am(hillshade_March_6am);
    ...
    System.out.println("March 6am hillshade uploaded");
