 ...
 * @author Chris
 */
public class OpenHillShade_August_midnight_Listener implements ActionListener
{

  private GUIPanel panel = null;
  private Storage store = null;

  OpenHillShade_August_midnight_Listener(GUIPanel pn, Storage s)
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      System.out.println("August midnight working");
  
   // Creates the "Open a File" dialog box

    FileDialog fd = new FileDialog(new Frame (), "Open August midnight hillshade ASCII", FileDialog.LOAD);
    fd.setVisible(true);
    ...
    {
    System.out.println("August midnight hillshade file not uploaded");
    return;
    }
    ...
    double hillshade_August_midnight[][] = gj.getTwoDdoubleArray();
           
    store.setHillshade_August_midnight(hillshade_August_midnight);
    ...
    System.out.println("August midnight hillshade uploaded");
